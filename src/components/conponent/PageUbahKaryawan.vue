<template>
  <div class="modal fade" id="modal-ubah-karyawan" tabindex="-1">
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        <h4 class="d-block w-full text-center py-4 mb-0">Form Ubah Karyawan</h4>
        ...
        <div class="modal-body">
          <form class="row g-3 text-start">
            <div class="col-md-12">
              ...
              <input v-model="formData.nama" type="text" class="form-control" id="input1" />
            </div>
            <div class="col-md-12">
              <label for="input2" class="form-label">NIK</label>
              <input v-model="formData.no_nik" type="text" class="form-control" id="input2" />
            </div>
            <div class="col-md-12">
              <label for="input3" class="form-label">Jabatan</label>
              <select v-model="formData.id_jabatan" class="form-select" id="input3">
            ...
            <div class="col-md-12">
              ...
              <input v-model="formData.nomor_telepon" type="text" class="form-control" id="input5" />
            </div>
            <div class="col-md-12">
              <label for="input5" class="form-label">Nomor Rekening</label>
              <input v-model="formData.no_rekening" type="text" class="form-control" id="input5" />
            </div>
          </form>
        ...
        <div class="modal-footer">
          ...
          <button type="button" @click="ubahData(formData.id)" class="btn btn-primary" data-bs-dismiss="">Ubah</button>
        </div>
      </div>
    </div>
  </div>
  ...
  watch: {
    dataKar: {
      ...
      handler(newData) {
        ...
        this.formData.no_nik = newData.no_nik;
        this.formData.id_jabatan = newData.id_jabatan;
        this.formData.jenis_kelamin = newData.jenis_kelamin;
        this.formData.tmp_lhr = newData.tmp_lhr;
        this.formData.tgl_lhr = newData.tgl_lhr;
        this.formData.kode_provinsi = newData.kode_provinsi;
        this.formData.kode_kabupaten = newData.kode_kabupaten;
        this.formData.kode_kecamatan = newData.kode_kecamatan;
        this.formData.nomor_telepon = newData.nomor_telepon;
        this.formData.no_rekening = newData.no_rekening;
      },
    },
  },
  ...
  methods: {
    ...
    async ubahData(id) {
      if (
        ...
        try {
          const response = await axios.patch(`${API_KEY}karyawan/${id}`, this.formData);
